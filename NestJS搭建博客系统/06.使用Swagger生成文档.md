...
```typescript {.line-numbers}
// src/modules/article/response/article-base.response.ts
...
```typescript {.line-numbers}
// src/modules/article/response/article-list.response.ts
...
```typescript {.line-numbers}
// src/modules/article/response/article-info.response.ts
